# nearby-parkings Specification

## Purpose
Búsqueda geoespacial de parkings cercanos: dada una ubicación y un radio, devuelve
los parkings ordenados por distancia (PostGIS), con filtros por tipo y estado. Es la
consulta que alimenta el mapa y la lista de la app.
## Requirements
