# propose-parking Specification

## Purpose
Propuesta de un parking nuevo por parte de la comunidad: el usuario aporta ubicación,
datos y foto, y el sistema lo registra en estado `pending` acreditando Octanos vía la
