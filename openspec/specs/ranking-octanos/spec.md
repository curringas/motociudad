# ranking-octanos Specification

## Purpose
Clasificación gamificada de usuarios por Octanos. Ofrece un ranking global y por
ciudad, con métricas conmutables (totales y del mes), podio, resaltado del usuario
actual y paginación. Lee de materialized views (`mv_ranking_global`,
`mv_ranking_by_city`) que ya filtran por visibilidad, garantizando privacidad y
acceso de lectura seguro sin depender de RLS.
