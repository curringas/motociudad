...
## Purpose
Gestión de usuarios en el panel de administración web (solo admin): listar, buscar
y filtrar por rol, ver el detalle (perfil, rol, estado, nivel, Octanos) y cambiar
rol o suspender/reactivar a través de la Edge Function `admin-set-role`.
## Requirements
